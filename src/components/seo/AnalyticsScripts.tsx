...
export function AnalyticsScripts() {
  const ga4 = siteConfig.ga4MeasurementId;
  const meta = siteConfig.metaPixelId;
      ...
      {ga4 && (
        <>
          ...
          <Script id="ga4-init" strategy="afterInteractive">
            {`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}window.gtag=window.gtag||gtag;gtag('js',new Date());gtag('config','${ga4}',{anonymize_ip:true,send_page_view:true});`}
          </Script>
        </>
      )}
      {meta && (
